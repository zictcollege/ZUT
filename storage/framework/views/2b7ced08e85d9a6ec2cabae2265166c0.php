                        ...
                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <select data-placeholder="Choose..." required name="assesmentID"
                                                ...
                                                onchange="StrMod4All('<?php echo e($firstAcademicData['program']); ?>','<?php echo e($firstAcademicData['academic']); ?>', this.value,'assess')">
                                            <option value=""></option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if(Qs::userIsTeamSA()): ?>
                                                                <a onclick="modifyMarks('<?php echo e($student['student_id']); ?>','<?php echo e($firstAcademicData['program']); ?>','<?php echo e($firstAcademicData['academic']); ?>','<?php echo e($course['code']); ?>','assess')"
                            ...
                            <div>
                                ...
                                <?php else: ?>
                                    ...
                                    onclick="LoadMoreResultsCas('<?php echo e($firstAcademicData['current_page']); ?>','<?php echo e($firstAcademicData['last_page']); ?>','<?php echo e($firstAcademicData['per_page']); ?>','<?php echo e($firstAcademicData['program']); ?>','<?php echo e($firstAcademicData['academic']); ?>','<?php echo e($firstAcademicData['level_id']); ?>')">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lavumweemba/Documents/zictcollegenewsms/zictcollege/resources/views/pages/academics/cas/results_review_board.blade.php ENDPATH**/ ?>