                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="form-group ">
                                <input type="text" class="form-control" name="email" value="<?php echo e(old('identity')); ?>" placeholder="Login ID or Email">
                            </div>
...
<?php echo $__env->make('layouts.login_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lavumweemba/Documents/test/zictcollege 08-10-40-916/resources/views/auth/login.blade.php ENDPATH**/ ?>