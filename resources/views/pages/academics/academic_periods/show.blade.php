                                                ...
                                                <div class="list-icons">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-left">
                                                            @if(Qs::userIsTeamSA())
                                                                <a href="{{ route('classes.customShow', ['period'=>Qs::hash($period['period']->id),'program' => Qs::hash($p['id'],)]) }}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                            @endif
{{--                                                            @if(Qs::userIsSuperAdmin())--}}
                                            ...
                                            <td class="text-center">
                                                <div class="list-icons">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-left">
                                                            @if(Qs::userIsTeamSA())
                                                                <a href="{{ route('classes.show', Qs::hash($p['key']))}}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                            @endif
                                                            {{--                                                            @if(Qs::userIsSuperAdmin())--}}
                                                            {{--                                                                <a id="{{ $p->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Delete</a>--}}
                                                            {{--                                                                <form method="post" id="item-delete-{{ $p->id }}" action="{{ route('intakes.destroy', $p->id) }}" class="hidden">@csrf @method('delete')</form>--}}
