                        ...
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('change_program_apply')  }}">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">Select Classes to add<span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">Select Classes to drop <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select Course" class="form-control select-search" name="qualification" id="courses">
                                            <option value=""></option>
                                            {{--                                            @foreach($period['instructors'] as $u)--}}
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">Explanation for dropping<span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
