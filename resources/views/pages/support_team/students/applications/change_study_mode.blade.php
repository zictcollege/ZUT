...
@section('page_title', 'Change Study Mode')
@section('content')
    @php
        use App\Helpers\Qs;
    @endphp
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Change Study Mode Applications</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                        ...
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('change_program_apply')  }}">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">Select Study Mode <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">Select New Academic Period<span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select Course" class="form-control select-search" name="qualification" id="courses">
                                            <option value=""></option>
                                            {{--                                            @foreach($period['instructors'] as $u)--}}
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">Select Classes <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select Course" class="form-control select-search" name="qualification" id="courses">
                                            <option value=""></option>
                                            {{--                                            @foreach($period['instructors'] as $u)--}}
