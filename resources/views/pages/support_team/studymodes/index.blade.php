    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                <li class="nav-item"><a href="#new-mode" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> Create New Study Mode</a></li>
            </ul>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                   ...
                                                   @endif
                                                    ...
                                                    <form method="post" id="item-delete-{{ $m->id }}" action="{{ route('studymodes.destroy', $m->id) }}" class="hidden">@csrf @method('delete')</form>
                                                        @endif
                        ...
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('studymodes.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="name" value="{{ old('name') }}" required type="text" class="form-control" placeholder="Name of Study Mode">
                                    </div>
                                </div>
