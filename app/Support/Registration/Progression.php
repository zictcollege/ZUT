...
trait Progression
{
    ...
    public static function classCalcualtor($nextClasses, $failedClasses, $passedClasses)
    {
        ...
        if (count($nextClasses)>0) {
            ...
            foreach ($nextClasses as $nClasses) {
                ...
                //    if(!empty($nClasses['prerequisiteCode'])){
                ...
                //         $key = array_search($nClasses['course_code'] , array_column($nextClasses, 'course_code'));
                //            unset($nextClasses[$key]);
                ...
                //         foreach( $nClasses['prerequisiteCode'] as $nClass){
                //             if ($fClass['course_code'] == $nClass['prerequisiteCode']) {

                //                 # Remove this class from the nextClassesArray
                //                 $_ = array_search($nClass, $nextClasses);
                //                 unset($nextClasses[$_]);
                //             }
                ...
                //     if($passedClasses){
                //         foreach( $nClasses['prerequisiteCode'] as $nClass){
                //         if ($pClass['course_code'] == $nClass['prerequisiteCode']) {
    ...
    public function getStudentProgress($userID, $programID)
    {
        ...
        # get program certification

        # get all grades from the grade book
