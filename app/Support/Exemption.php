...
use App\Models\Academics\Classes as AcademicAcClass;
...
use App\Models\Exemption as AcademicExemption;
use App\Models\User;
use Carbon\Carbon;
...
class Exemption
{
    ...
    {
        return Programs::data(request('programID'));
    }
    ...
    public static function exemptionLevel($exemptionID)
    {
        ...
        if ($exemptionCourses) {
            foreach ($exemptionCourses as $exemptionCourse) {
                $eEourses[] = Courses::data($exemptionCourse->courseID);
            }
        }
