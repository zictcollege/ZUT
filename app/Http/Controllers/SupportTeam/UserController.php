...
class UserController extends Controller
{
    ...
    public function store(UserRequest $req)
    {
        ...
        if($req->hasFile('photo')) {
            ...
            $f['name'] = 'photo.' . $f['ext'];
            $f['path'] = $photo->storeAs(UserController . phpQs::getUploadPath($user_type) . $data['code'], $f['name']);
    ...
    public function update(UserRequest $req, $id)
    {
        ...
        if($req->hasFile('photo')) {
            ...
            $f = Qs::getFileMetaData($photo);
            $f['name'] = 'photo.' . $f['ext'];
            $f['path'] = $photo->storeAs(UserController . phpQs::getUploadPath($user_type) . $user->code, $f['name']);
            $data['photo'] = asset('storage/' . $f['path']);
        }
    ...
    public function destroy($id)
    {
        ...
        $path = UserController . phpQs::getUploadPath($user->user_type) . $user->code;
